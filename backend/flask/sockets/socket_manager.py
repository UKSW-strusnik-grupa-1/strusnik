...
def handle_join_game_room(data):
    ...
    if not lobby:
        emit('join_room_response', {'success': False, 'message': f'Lobby gry nie istnieje lub nie znaleziono pokoju'})
        return
    ...
    if room:
        ...
        if room.game_instance is None and lobby.game_class:
            room.game_instance = lobby.game_class(list(room.player_tokens))
